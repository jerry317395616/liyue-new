				...
				<view class="u-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
					<view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" v-for="(item, index) in list" :key="index" @tap="clickTab(index)"
					 :style="[tabItemStyle(index)]">
						<view style="display: inline-block; position: relative;" v-if="item.activeIcon">
							<view style="display:-webkit-box; -webkit-box-pack:center; -webkit-box-align:center;">
								<u-badge :absolute="true" :offset="[45, 30]" bgColor="#FF5363" :count="item.count" :show-zero="false" style="z-index: 9999;"></u-badge>
								<u-image :fade="false" width="54rpx" height="54rpx" :src="index === currentIndex ? item.activeIcon : item.inactiveIcon"></u-image>
							</view>
